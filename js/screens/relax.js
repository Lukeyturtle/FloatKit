...
import { RELAX_OPTIONS } from '../catalog.js';
...
export function render(app, { squareId }) {
  ...
  const wrap = h('div', { class: 'screen' }, [
    h('div', { class: 'screen-head' }, [
      h('h2', {}, '🛋️ Customize your Relax square'),
      h('p', { class: 'muted' }, 'How do you want to lounge?'),
    ]),
    optionGrid(RELAX_OPTIONS, sq.config.option, (id) => {
